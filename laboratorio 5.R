...
ggsave("PetalLength_violin_boxplot.png", p, width = 6, height = 4, dpi = 300)
write.csv(desc, "HW02_descriptivos.csv", row.names = FALSE)
capture.output(vtest, t_res, d_res, d_manual, file = "HW02_resultados.txt")
